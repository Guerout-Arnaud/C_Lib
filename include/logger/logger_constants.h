...
static const char *LOG_TYPE_PRINT[] = {
        NULL_STR,
        INFO_STR_C,
        WARN_STR_C,
        ERROR_STR_C,
...
static const char *LOG_TYPE_FILE[] = {
        NULL_STR,
        INFO_STR,
        WARN_STR,
        ERROR_STR,
...
#define FILE_START_MESSAGE "\nLogs will be formated like so:\n"\
    "[Date (YYYY/MM/DD)] [TYPE 1][Type 2 (if DEBUG active)] Log Message\n\n"\
    "Logs Starts Now.\n\n"
